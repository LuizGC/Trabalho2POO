...
public class Livro extends Publicacao implements Emprestavel{
	...
	public Livro(int codPublicacao, String titulo, String editora,
			int ano, String autores, int qtdeExamplares) {
	...
	public int menosUmLivro() throws Exception{
		if(qtdeExamplares > 0){
			return qtdeExamplares--;
			 ...
			 throw new Exception("Quantidade de examplares Ž 0, sendo impossivel subtrair um livro.");
		}
	}
