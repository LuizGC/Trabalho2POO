...
public class Biblioteca {
	...
	public void add(Emprestimo emprestimo, Emprestavel publicacao) throws Exception{
	...
	public void remove(Usuario usuario) throws Exception{
		for(Emprestimo emprestimo : emprestimos){
			if(emprestimo.getUsuario().equals(usuario))
				throw new Exception("Usuario possui emprestimos só pode ser removido se o emprestimo pendente for finalizar.");		
		}
		...
		if(publicacao instanceof Emprestavel){
			for(Emprestimo emprestimo : emprestimos){
				if(emprestimo.contem((Emprestavel)publicacao))
					throw new Exception("Essa publicacao esta emprestada só pode ser removido se emprestimo pendente for finalizado.");	
			}
		}
	...
	public void remove(Emprestimo emprestimo, Emprestavel publicacao) throws Exception{
		emprestimo = this.getEmprestimo(emprestimo.getNumero());
		emprestimo.excluirItem(publicacao);
	}
	
	public void realizarDevolucao(Emprestimo emprestimo, Emprestavel publicacao) throws Exception{
		emprestimo = this.getEmprestimo(emprestimo.getNumero());
		emprestimo.excluirItem(publicacao);
	}
	
	public void realizarDevolucaoDeTodosOsItens(Emprestimo emprestimo) throws Exception{
		emprestimo = this.getEmprestimo(emprestimo.getNumero());
		emprestimo.devolucaoDeTodosItensEmprestados();
	}
